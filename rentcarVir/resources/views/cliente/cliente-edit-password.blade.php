    ...
    <div class="card shadow-sm p-4 mb-4">
        ...
        <form action="{{ route('cliente.update.password') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="password" id="oldPassword" name="oldPassword" class="form-control w-50 mx-auto" required>
            </div>

            <!-- Nueva contraseña y confirmación -->
            <div class="mb-3 row">
                <div class="col-md-5 mb-3 nueva-contrasena"> <!-- Clase personalizada aquí -->
                    <label for="password" class="form-label">Nueva contraseña:</label>
                    <input type="password" id="password" name="password" class="form-control" required>
                </div>
                <div class="col-md-5 mb-3 confirmar-contrasena"> <!-- No necesitas ms-8 aquí, solo la clase personalizada -->
