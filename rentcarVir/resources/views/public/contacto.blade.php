...
<section class="container mt-7 py-5">
    <div class="contact-container">
        <div class="contact-info">
            ...
            <address>
                ...
                <a href="mailto:RentCarVir@soporte.com" title="E-mail Empleado" class="d-block mb-2">
                ...
                <p>Calle Miguel Marquez, 29640 Fuengirola, Málaga, España</p>
            </address>
        </div>
        <div class="contact-logo">
            <img src="{{ asset('img/LOGORENT.png') }}" alt="Logotipo Rent Car Vir">
